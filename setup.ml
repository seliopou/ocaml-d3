...
(* OASIS_START *)
(* DO NOT EDIT (digest: 49090f73bed203e062296fed93ec25a4) *)
(*
...
let setup_t =
  {
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/seliopou/ocaml-d3.git";
                      src_repo_browser =
                        Some "https://github.com/seliopou/ocaml-d3";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\151\176<\181\231\162(J'\141+EV\193\231\167";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
